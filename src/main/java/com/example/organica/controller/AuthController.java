...
import com.example.organica.payload.JwtAuthenticationResponse;
import com.example.organica.payload.LoginRequest;
import com.example.organica.payload.SignUpRequest;
import com.example.organica.repository.RoleRepository;
import com.example.organica.repository.UserRepository;
import com.example.organica.security.JwtTokenProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        ...
        User user = new User(signUpRequest.getName(), signUpRequest.getUsername(), signUpRequest.getPassword(),
                signUpRequest.getEmail(), signUpRequest.getPhoneNum());

        System.out.println(passwordEncoder.encode(user.getPassword()).length());
